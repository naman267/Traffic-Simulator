...
def repeat():
    global currentGreen, currentYellow, nextGreen, ambulance_cur_direction, crossed
...
def generateVehicles():
    global exit_success, total_ambulance, ambulance_cur_direction, crossed, total_vehicles
    while(True):
